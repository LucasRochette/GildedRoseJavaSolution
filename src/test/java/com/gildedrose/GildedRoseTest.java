...
class GildedRoseTest {
    ...
    @Test
    public void should_lower_quality_twice_as_fast_when_past_expiration_date() throws Exception {
    ...
    @Test
    public void should_never_lower_quality_value_below_zero() throws Exception {
    ...
    @Test
    public void should_increase_aged_brie_quality_at_the_end_of_each_day() throws Exception {
    ...
    @Test
    public void should_never_increase_aged_brie_quality_above_50() throws Exception {
    ...
    @Test
    public void should_never_lower_sulfuras_quality_and_sellIn_values() throws Exception {
        Item[] items = new Item[]{
    ...
    @Test
    public void should_increase_backstage_passes_quality_at_the_end_of_each_day() throws Exception {
    ...
    @Test
    public void should_never_increase_backstage_passes_quality_above_50() throws Exception {
        Item[] items = new Item[]{new ItemBuilder().called("Backstage passes to a TAFKAL80ETC concert").toBeSoldIn(20)
                .ofQuality(50).build()};
        GildedRose app = new GildedRose(items);
    ...
    @Test
    public void should_increase_backstage_passes_quality_twice_as_fast_when_sellIn_value_is_equal_or_less_than_10()
            throws Exception {
    ...
    @Test
    public void should_increase_backstage_passes_quality_thrice_as_fast_when_sellIn_value_is_equal_or_less_than_5()
            throws Exception {
    ...
    @Test
    public void should_lower_backstage_passes_quality_to_zero_when_past_expiration_date() throws Exception {
